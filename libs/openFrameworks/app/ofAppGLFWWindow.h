...
#else
	static void 	static void keyboard_cb(GLFWwindow* windowP_, int key, int scancode, int action, int mods);
	static void 	static void drop_cb(GLFWwindow* windowP_, const char* dropString);
